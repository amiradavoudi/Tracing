...
we also provide the file *generate-figure6-b-condensed.py*, which takes a subset of the precomputed average success rates
as input and generates the figure. It takes about 30 minutes to get the result. <br>
