...
'''
Impact of the billing period length on the average success rate (ASR)
'''

logfile = 'figure3(e).log'
logger1 = sys_log(logfile, 'figure3(e)', 0)
...
'''
The imodel1.integer_var_dict line code create variables in batches, not one by one
'''
...
for num_billing_period in range(1, 9):
    ...
    dict_wallet_sols = create_list_of_all_sols_cycle_type_freq(length_of_toll_price, q, all_sols)
...
plt.savefig("ASR-billing-period.pdf", format="pdf", bbox_inches="tight")
plt.show()
