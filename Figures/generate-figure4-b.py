...
'''
Function create_model_inequality creates Inequality 5 in the paper based on the toll prices and the lower and 
upper bound of the wallet range
'''
...
# Function create_model_equation creates Equation 3 in the paper based on the toll prices and the wallet balance
...
for lower_wallet, upper_wallet in zip(list_lower_wallet, list_upper_wallet):
    ...
    for wallet_ in list_of_wallets:
        ...
        # Function imodel.start_search() solves the equality in the model
...
plt.savefig("figure4-b.pdf", format="pdf", bbox_inches="tight")
plt.show()
