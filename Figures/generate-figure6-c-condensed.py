...
ranges [1,1], [1,2], [1,3], [1,4], [1,5], [1,6], and [1,7] which takes quite large time of computation. The ASRs for the
rest of the toll price ranges are generated through the below code. The precomputed average success rates are stored in
the list, namely list_of_list_of_avg_success_rates. 
'''
