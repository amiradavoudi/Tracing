...
precompute the ASRs for the toll price ranges [1,1], [1,2], [1,3] and [1,4] which takes quite large time of computation. The 
ASRs for the rest of the toll price ranges are generated through the below code.
'''
