// The algorithm for partitioning comes from
...
//File create_partitions.js gets the file"plausible_traces.txt" as its input and creates all the corresponding partitions, written
// to the file "partitions.txt".
...
fs.readFile('plausible_traces.txt', (err, inputD) => {
    ...
    var file = fs.createWriteStream('C:\\Luxembourg\\AA-Projects\\AA-TrackingSim Projests\\AA-TrackingSim\\Brisbane Individual Case Studies-Cleared-Impact of parameters-three-case-studies(Cycles-all-pattern)\\partitions.txt');
