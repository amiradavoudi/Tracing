...
'''
Generates the graph concerning the number of solutions per wallet balance
'''

logfile = 'figure2(a).log'
logger1 = sys_log(logfile, 'figure2(a).log', 0)
...
for lower_wallet, upper_wallet in zip(list_lower_wallet, list_upper_wallet):
    ...
    counter = counter + 1
plt.savefig("solutions.pdf", format="pdf", bbox_inches="tight")
plt.show()
