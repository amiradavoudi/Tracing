...
'''
Impact of the wallet balance on the success rate
'''

logfile = 'figure3(d).log'
logger1 = sys_log(logfile, 'figure3(d)', 0)
...
plt.savefig("success-rate-wallet.pdf", format="pdf", bbox_inches="tight")
plt.show()
